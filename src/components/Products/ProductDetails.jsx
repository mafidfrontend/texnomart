...
function ProductDetail() {
    ...
    if (loading) return <div className="text-center mt-20"><Spin size="large" /></div>;
    if (error) return <div className="text-center mt-20 text-red-500">{error}</div>;
    if (!product) return <div className="text-center mt-20">Mahsulot topilmadi</div>;
        ...
        <div className="container mx-auto p-4 flex items-center justify-between">
            <div className="w-full">
                <img
                    ...
                    src={product.large_images?.length ? product.large_images[0] : "https://via.placeholder.com/500"}
                    ...
                    <div className="mt-5 mb-4">
                        {product.main_characters?.length ? (
                            product.main_characters.map((item, index) => (
                                ...
                                >
                                    <p className="text-[14px] w-full">{item.name}</p>
                            ...
                            <p className="text-center text-gray-500">Xususiyatlar mavjud emas</p>
                        )}
                    </div>
                    <a href="#"><span className="mt-4">Barcha xususiyatlar</span></a>
                </Card>
            </div>
